		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					<p class="cm-text">
					<textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" onblur="if(this.value == \'\') this.value = \''.__('Your Message','leafcolor').'\';" onfocus="if(this.value == \''.__('Your Message','leafcolor').'\') this.value = \'\'; jQuery(\'.comment-form-tm .collapse\').addClass(\'in\');">'.__('Your Message','leafcolor').'</textarea>
					</p>
					</p>';
