...
//color
$main_color_1 = ot_get_option('main_color_1');
if(isset($_GET['color']) && $_GET['color']){ $main_color_1 = '#'.$_GET['color'];}
if($main_color_1){ ?>
...
.woocommerce .widget_price_filter .ui-slider-horizontal .ui-slider-range, .woocommerce-page .widget_price_filter .ui-slider-horizontal .ui-slider-range,
    ...
    .thumbnail-overlay {
    	background: rgba(<?php echo esc_attr(hex2rgba($main_color_1,80)); ?>);
    }
...
if($main_color_2 = ot_get_option('main_color_2')){ ?>
	.main-color-2, .main-color-2-hover:hover{
        color:<?php echo esc_attr($main_color_2) ?>;
    }
    .main-color-2-bg{
        background-color:<?php echo esc_attr($main_color_2) ?>;
    }
<?php
}//main color 2
if($nav_bg = ot_get_option('nav_bg')){
$nav_bg = hex2rgba($nav_bg,ot_get_option('nav_opacity',100));
?>
...
if($footer_bg = ot_get_option('footer_bg','#2b2b2b')){ ?>
